...
class LSFOdysseyShuffle(torch.utils.data.Dataset):
    def __init__(
        self,
        aug_params=None,
        root="none",
        ...
        super(LSFOdysseyShuffle, self).__init__()
    ...
    def get_data_unit(self, index):
        ...
        if self.train_mode and self.augmentor is not None:
            depths = aug_depth(
                depths,
                grid=(8, 8),
                scale=(0.85, 1.15),
