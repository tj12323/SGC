...
oridir = "current-data-dir/ood/HOI4D_release"

mp4_files = sorted(glob(f'{oridir}/**/*.mp4', recursive=True))

images_folder = 'current-data-dir/HOI4D/images'
mask_folder = "current-data-dir/HOI4D/dynamic_masks"
...
for i, video_path in tqdm(enumerate(mp4_files), "converting:"):
    ...
    ori_mask_dir = os.path.join(ori_mask_dir, "2Dseg", "shift_mask")
