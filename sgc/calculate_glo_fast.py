...
def evaluate_3d_consistency(args):
    ...
    for idx in range(num_pairs):
        ...
        frame_pair_scores.append(SGC)

    all_results['frame_pair_STC_scores'] = frame_pair_scores
    logging.info("The SGC score for each frame pair is calculated.")
    return all_results
...
if __name__ == "__main__":
    ...
    parser.add_argument("--summary_txt_path", type=str, default="sgc/composite_4d_consistency_summary_pca_weights.txt", help="Path to the summary file containing normalization parameters and PCA weights.")
    ...
    try:
        ...
        os.makedirs(os.path.join('result','score',video_name_top), exist_ok=True)
        ...
        if results:
            ...
            logging.info(f"Saved per-pair SGC scores → {args.output_json}")
